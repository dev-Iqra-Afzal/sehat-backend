...
# DATABASE_URL = "postgresql://resource_user:resource_db_password@postgres/resource_db"
# DATABASE_URL = "postgresql+asyncpg://resource_user:resource_db_password@postgres:5432/resource_db"
