...
class AppSettings(BaseSettings):
    APP_NAME: str = os.getenv("APP_NAME", "Resources Service")
...
class DatabaseSettings(BaseSettings):
    POSTGRES_USER: str = os.getenv("POSTGRES_USER", "resource_user")
    POSTGRES_PASSWORD: str = os.getenv("POSTGRES_PASSWORD", "resource_db_password")
